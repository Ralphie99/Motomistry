package com.motomistry.motomistry.New.ListXpandable;
...
import com.motomistry.motomistry.New.Adapter.VenderListAdapter;

class SlideExpandableListView extends ListView {
    private VenderListAdapter adapter;
    ...
    public void setAdapter(ListAdapter adapter) {
      //  this.adapter = new VenderListAdapter(adapter);
        super.setAdapter(this.adapter);
    }

    public void setAdapter(ListAdapter adapter, int toggle_button_id, int expandable_view_id) {
        this.adapter = new VenderListAdapter(adapter, toggle_button_id, expandable_view_id);
        super.setAdapter(this.adapter);
    }
